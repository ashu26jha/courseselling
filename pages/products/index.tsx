            ...
            <div className="flex flex-wrap">
                ...
                courseDetails? 
                    courseDetails.map((item,index)=>(
                        <Cards courseName={item.node.courseName} courseID={item.node.courseCode} imgURL="https://i.ibb.co/Lg7dJfN/Screenshot-2023-06-12-at-23-56-19.png" price={item.node.price}/>))
                :<></>}
            </div>
        </div>
